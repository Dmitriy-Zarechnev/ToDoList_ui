...
test("correct task should be deleted from correct array", () => {
  ...
  const endState = tasksReducer(startState,
    tasksThunks.deleteTask.fulfilled(args, "requestId", args));
...
test("status of specified task should be changed", () => {
  ...
  const endState = tasksReducer(startState,
    tasksThunks.updateTaskStatus.fulfilled(args, "requestId", args));
...
test("title of specified task should be changed", () => {
  ...
  const endState = tasksReducer(startState,
    tasksThunks.updateTaskTitle.fulfilled(args, "requestId", args));
...
test("new array should be added when new todolist is added", () => {
  const endState = tasksReducer(startState,
    toDoListsThunks.addTodoLists.fulfilled({ title: "new todolist", toDoListID: "todolistId" },
      "requestId",
      "new todolist"));
...
test("property with todolistId should be deleted", () => {
  const endState = tasksReducer(startState,
    toDoListsThunks.deleteTodoLists.fulfilled({ toDoListID: "todolistId2" }, "requestId", "todolistId2"));
...
test("new array should be added when new todolist is set", () => {
  ...
  const endState = tasksReducer(
    startState,
    toDoListsThunks.getTodoLists.fulfilled({
      toDoLists: [
        {
          id: "123",
          title: "What to learn",
...
test("tasks entity status should be changed", () => {
  ...
  const endState = tasksReducer(startState,
    tasksActions.changeTaskEntityStatus({ toDoListID: "todolistId1", taskId: "1", entityTaskStatus: "loading" }));
