...
import {captchaUrlSelector, isLoggedInSelector} from 'features/auth/model/auth-selector'
...
export const LogIn = () => {
    ...
    // Получили captchaUrl из state используя хук - useSelector и selector - captchaUrlSelector
